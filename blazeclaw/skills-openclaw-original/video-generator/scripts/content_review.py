...
def review_video(video_url, original_prompt, user_input):
    """
    审查生成的视频内容
    
    Args:
        video_url: 视频文件的 URL
        original_prompt: 生成视频使用的中文提示词
        user_input: 用户原始输入的动物名称
    ...
    """
    prompt = f"""请审查这个 AI 生成的视频，从以下三个维度进行评估：
