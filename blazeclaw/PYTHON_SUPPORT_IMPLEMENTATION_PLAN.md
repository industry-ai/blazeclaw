...
- Planned alignment for long-term extensibility:
  ...
  - current status: Option 5/6 rollout has progressed through Phase 8,
    and the Phase 7 checklist gap is closed with explicit
    policy-precedence unit tests (`tool > capability > default`).
- Added tests:
