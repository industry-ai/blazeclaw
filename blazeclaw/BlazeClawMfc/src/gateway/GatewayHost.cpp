...
namespace blazeclaw::gateway {
	...
	void GatewayHost::RegisterDefaultHandlers() {
		...
		m_dispatcher.Register("gateway.tools.templateScopeKey", [this](const protocol::RequestFrame& request) {
			const auto tools = m_toolRegistry.List();
			return protocol::ResponseFrame{
				.id = request.id,
				.ok = true,
				.payloadJson = "{\"templateScopedKey\":0,\"fallback\":0,\"tools\":" + std::to_string(tools.size()) + "}",
				.error = std::nullopt,
			};
			});

		m_dispatcher.Register("gateway.models.templateScopeKey", [](const protocol::RequestFrame& request) {
			return protocol::ResponseFrame{
				.id = request.id,
				.ok = true,
				.payloadJson = "{\"models\":[\"default\",\"reasoner\"],\"count\":2}",
		...
		m_dispatcher.Register("gateway.config.templateScopeKey", [](const protocol::RequestFrame& request) {
			return protocol::ResponseFrame{
				.id = request.id,
				.ok = true,
				.payloadJson = "{\"sections\":[\"gateway\",\"agent\"],\"count\":2}",
		...
		m_dispatcher.Register("gateway.transport.policy.templateScopeKey", [this](const protocol::RequestFrame& request) {
			return protocol::ResponseFrame{
				.id = request.id,
				.ok = true,
				.payloadJson = "{\"templateScopeScoped\":false,\"version\":1,\"applied\":false}",
				.error = std::nullopt,
			};
			});

		m_dispatcher.Register("gateway.tools.revisionScopeKey", [this](const protocol::RequestFrame& request) {
			const auto tools = m_toolRegistry.List();
			return protocol::ResponseFrame{
				.id = request.id,
				.ok = true,
				.payloadJson = "{\"revisionScopedKey\":0,\"fallback\":0,\"tools\":" + std::to_string(tools.size()) + "}",
				.error = std::nullopt,
			};
			});

		m_dispatcher.Register("gateway.models.revisionScopeKey", [](const protocol::RequestFrame& request) {
			return protocol::ResponseFrame{
				.id = request.id,
				.ok = true,
				.payloadJson = "{\"models\":[\"default\",\"reasoner\"],\"count\":2}",
		...
		m_dispatcher.Register("gateway.config.revisionScopeKey", [](const protocol::RequestFrame& request) {
			return protocol::ResponseFrame{
				.id = request.id,
				.ok = true,
				.payloadJson = "{\"sections\":[\"gateway\",\"agent\"],\"count\":2}",
		...
		m_dispatcher.Register("gateway.transport.policy.revisionScopeKey", [this](const protocol::RequestFrame& request) {
			return protocol::ResponseFrame{
				.id = request.id,
				.ok = true,
				.payloadJson = "{\"revisionScopeScoped\":false,\"version\":1,\"applied\":false}",
				.error = std::nullopt,
			};
			});

		m_dispatcher.Register("gateway.tools.historyScopeKey", [this](const protocol::RequestFrame& request) {
			const auto tools = m_toolRegistry.List();
			return protocol::ResponseFrame{
				.id = request.id,
				.ok = true,
				.payloadJson = "{\"historyScopedKey\":0,\"fallback\":0,\"tools\":" + std::to_string(tools.size()) + "}",
				.error = std::nullopt,
			};
			});

		m_dispatcher.Register("gateway.models.historyScopeKey", [](const protocol::RequestFrame& request) {
			return protocol::ResponseFrame{
				.id = request.id,
				.ok = true,
				.payloadJson = "{\"models\":[\"default\",\"reasoner\"],\"count\":2}",
		...
		m_dispatcher.Register("gateway.config.historyScopeKey", [](const protocol::RequestFrame& request) {
			return protocol::ResponseFrame{
				.id = request.id,
				.ok = true,
				.payloadJson = "{\"sections\":[\"gateway\",\"agent\"],\"count\":2}",
		...
		m_dispatcher.Register("gateway.transport.policy.historyScopeKey", [this](const protocol::RequestFrame& request) {
			return protocol::ResponseFrame{
				.id = request.id,
				.ok = true,
				.payloadJson = "{\"historyScopeScoped\":false,\"version\":1,\"applied\":false}",
				.error = std::nullopt,
			};
			});

		m_dispatcher.Register("gateway.tools.snapshotScopeKey", [this](const protocol::RequestFrame& request) {
			const auto tools = m_toolRegistry.List();
			return protocol::ResponseFrame{
				.id = request.id,
				.ok = true,
				.payloadJson = "{\"snapshotScopedKey\":0,\"fallback\":0,\"tools\":" + std::to_string(tools.size()) + "}",
				.error = std::nullopt,
			};
			});

		m_dispatcher.Register("gateway.models.snapshotScopeKey", [](const protocol::RequestFrame& request) {
			return protocol::ResponseFrame{
				.id = request.id,
				.ok = true,
				.payloadJson = "{\"models\":[\"default\",\"reasoner\"],\"count\":2}",
		...
		m_dispatcher.Register("gateway.config.snapshotScopeKey", [](const protocol::RequestFrame& request) {
			return protocol::ResponseFrame{
				.id = request.id,
				.ok = true,
				.payloadJson = "{\"sections\":[\"gateway\",\"agent\"],\"count\":2}",
		...
		m_dispatcher.Register("gateway.transport.policy.snapshotScopeKey", [this](const protocol::RequestFrame& request) {
			return protocol::ResponseFrame{
				.id = request.id,
				.ok = true,
				.payloadJson = "{\"snapshotScopeScoped\":false,\"version\":1,\"applied\":false}",
				.error = std::nullopt,
			};
			});

		m_dispatcher.Register("gateway.tools.indexScopeKey", [this](const protocol::RequestFrame& request) {
			const auto tools = m_toolRegistry.List();
			return protocol::ResponseFrame{
				.id = request.id,
				.ok = true,
				.payloadJson = "{\"indexScopedKey\":0,\"fallback\":0,\"tools\":" + std::to_string(tools.size()) + "}",
				.error = std::nullopt,
			};
			});

		m_dispatcher.Register("gateway.models.indexScopeKey", [](const protocol::RequestFrame& request) {
			return protocol::ResponseFrame{
				.id = request.id,
				.ok = true,
				.payloadJson = "{\"models\":[\"default\",\"reasoner\"],\"count\":2}",
		...
		m_dispatcher.Register("gateway.config.indexScopeKey", [](const protocol::RequestFrame& request) {
			return protocol::ResponseFrame{
				.id = request.id,
				.ok = true,
				.payloadJson = "{\"sections\":[\"gateway\",\"agent\"],\"count\":2}",
		...
		m_dispatcher.Register("gateway.transport.policy.indexScopeKey", [this](const protocol::RequestFrame& request) {
			return protocol::ResponseFrame{
				.id = request.id,
				.ok = true,
				.payloadJson = "{\"indexScopeScoped\":false,\"version\":1,\"applied\":false}",
				.error = std::nullopt,
			};
			});

		m_dispatcher.Register("gateway.tools.windowScopeId", [this](const protocol::RequestFrame& request) {
			const auto tools = m_toolRegistry.List();
			return protocol::ResponseFrame{
				.id = request.id,
				.ok = true,
				.payloadJson = "{\"windowScopedId\":0,\"fallback\":0,\"tools\":" + std::to_string(tools.size()) + "}",
				.error = std::nullopt,
			};
			});

		m_dispatcher.Register("gateway.models.windowScopeId", [](const protocol::RequestFrame& request) {
			return protocol::ResponseFrame{
				.id = request.id,
				.ok = true,
				.payloadJson = "{\"models\":[\"default\",\"reasoner\"],\"count\":2}",
		...
		m_dispatcher.Register("gateway.config.windowScopeId", [](const protocol::RequestFrame& request) {
			return protocol::ResponseFrame{
				.id = request.id,
				.ok = true,
				.payloadJson = "{\"sections\":[\"gateway\",\"agent\"],\"count\":2}",
		...
		m_dispatcher.Register("gateway.transport.policy.windowScopeId", [this](const protocol::RequestFrame& request) {
			return protocol::ResponseFrame{
				.id = request.id,
				.ok = true,
				.payloadJson = "{\"windowScopeScopedId\":false,\"version\":1,\"applied\":false}",
				.error = std::nullopt,
			};
			});

		m_dispatcher.Register("gateway.tools.cursorScopeId", [this](const protocol::RequestFrame& request) {
			const auto tools = m_toolRegistry.List();
			return protocol::ResponseFrame{
				.id = request.id,
				.ok = true,
				.payloadJson = "{\"cursorScopedId\":0,\"fallback\":0,\"tools\":" + std::to_string(tools.size()) + "}",
				.error = std::nullopt,
			};
			});

		m_dispatcher.Register("gateway.models.cursorScopeId", [](const protocol::RequestFrame& request) {
			return protocol::ResponseFrame{
				.id = request.id,
				.ok = true,
				.payloadJson = "{\"models\":[\"default\",\"reasoner\"],\"count\":2}",
		...
		m_dispatcher.Register("gateway.config.cursorScopeId", [](const protocol::RequestFrame& request) {
			return protocol::ResponseFrame{
				.id = request.id,
				.ok = true,
				.payloadJson = "{\"sections\":[\"gateway\",\"agent\"],\"count\":2}",
		...
		m_dispatcher.Register("gateway.transport.policy.cursorScopeId", [this](const protocol::RequestFrame& request) {
			return protocol::ResponseFrame{
				.id = request.id,
				.ok = true,
				.payloadJson = "{\"cursorScopeScopedId\":false,\"version\":1,\"applied\":false}",
				.error = std::nullopt,
			};
			});

		m_dispatcher.Register("gateway.tools.anchorScopeId", [this](const protocol::RequestFrame& request) {
			const auto tools = m_toolRegistry.List();
			return protocol::ResponseFrame{
				.id = request.id,
				.ok = true,
				.payloadJson = "{\"anchorScopedId\":0,\"fallback\":0,\"tools\":" + std::to_string(tools.size()) + "}",
				.error = std::nullopt,
			};
			});

		m_dispatcher.Register("gateway.models.anchorScopeId", [](const protocol::RequestFrame& request) {
			return protocol::ResponseFrame{
				.id = request.id,
				.ok = true,
				.payloadJson = "{\"models\":[\"default\",\"reasoner\"],\"count\":2}",
		...
		m_dispatcher.Register("gateway.config.anchorScopeId", [](const protocol::RequestFrame& request) {
			return protocol::ResponseFrame{
				.id = request.id,
				.ok = true,
				.payloadJson = "{\"sections\":[\"gateway\",\"agent\"],\"count\":2}",
		...
		m_dispatcher.Register("gateway.transport.policy.anchorScopeId", [this](const protocol::RequestFrame& request) {
			return protocol::ResponseFrame{
				.id = request.id,
				.ok = true,
				.payloadJson = "{\"anchorScopeScopedId\":false,\"version\":1,\"applied\":false}",
				.error = std::nullopt,
			};
			});

		m_dispatcher.Register("gateway.tools.offsetScopeId", [this](const protocol::RequestFrame& request) {
			const auto tools = m_toolRegistry.List();
			return protocol::ResponseFrame{
				.id = request.id,
				.ok = true,
				.payloadJson = "{\"offsetScopedId\":0,\"fallback\":0,\"tools\":" + std::to_string(tools.size()) + "}",
				.error = std::nullopt,
			};
			});

		m_dispatcher.Register("gateway.models.offsetScopeId", [](const protocol::RequestFrame& request) {
			return protocol::ResponseFrame{
				.id = request.id,
				.ok = true,
				.payloadJson = "{\"models\":[\"default\",\"reasoner\"],\"count\":2}",
		...
		m_dispatcher.Register("gateway.config.offsetScopeId", [](const protocol::RequestFrame& request) {
			return protocol::ResponseFrame{
				.id = request.id,
				.ok = true,
				.payloadJson = "{\"sections\":[\"gateway\",\"agent\"],\"count\":2}",
		...
		m_dispatcher.Register("gateway.transport.policy.offsetScopeId", [this](const protocol::RequestFrame& request) {
			return protocol::ResponseFrame{
				.id = request.id,
				.ok = true,
				.payloadJson = "{\"offsetScopeScopedId\":false,\"version\":1,\"applied\":false}",
				.error = std::nullopt,
			};
			});

		m_dispatcher.Register("gateway.tools.pointerScopeId", [this](const protocol::RequestFrame& request) {
			const auto tools = m_toolRegistry.List();
			return protocol::ResponseFrame{
				.id = request.id,
				.ok = true,
				.payloadJson = "{\"pointerScopedId\":0,\"fallback\":0,\"tools\":" + std::to_string(tools.size()) + "}",
				.error = std::nullopt,
			};
			});

		m_dispatcher.Register("gateway.models.pointerScopeId", [](const protocol::RequestFrame& request) {
			return protocol::ResponseFrame{
				.id = request.id,
				.ok = true,
				.payloadJson = "{\"models\":[\"default\",\"reasoner\"],\"count\":2}",
		...
		m_dispatcher.Register("gateway.config.pointerScopeId", [](const protocol::RequestFrame& request) {
			return protocol::ResponseFrame{
				.id = request.id,
				.ok = true,
				.payloadJson = "{\"sections\":[\"gateway\",\"agent\"],\"count\":2}",
		...
		m_dispatcher.Register("gateway.transport.policy.pointerScopeId", [this](const protocol::RequestFrame& request) {
			return protocol::ResponseFrame{
				.id = request.id,
				.ok = true,
				.payloadJson = "{\"pointerScopeScopedId\":false,\"version\":1,\"applied\":false}",
				.error = std::nullopt,
			};
			});

		m_dispatcher.Register("gateway.tools.tokenScopeId", [this](const protocol::RequestFrame& request) {
			const auto tools = m_toolRegistry.List();
			return protocol::ResponseFrame{
				.id = request.id,
				.ok = true,
				.payloadJson = "{\"tokenScopedId\":0,\"fallback\":0,\"tools\":" + std::to_string(tools.size()) + "}",
				.error = std::nullopt,
			};
			});

		m_dispatcher.Register("gateway.models.tokenScopeId", [](const protocol::RequestFrame& request) {
			return protocol::ResponseFrame{
				.id = request.id,
				.ok = true,
				.payloadJson = "{\"models\":[\"default\",\"reasoner\"],\"count\":2}",
		...
		m_dispatcher.Register("gateway.config.tokenScopeId", [](const protocol::RequestFrame& request) {
			return protocol::ResponseFrame{
				.id = request.id,
				.ok = true,
				.payloadJson = "{\"sections\":[\"gateway\",\"agent\"],\"count\":2}",
		...
		m_dispatcher.Register("gateway.transport.policy.tokenScopeId", [this](const protocol::RequestFrame& request) {
			return protocol::ResponseFrame{
				.id = request.id,
				.ok = true,
				.payloadJson = "{\"tokenScopeScopedId\":false,\"version\":1,\"applied\":false}",
				.error = std::nullopt,
			};
			});

		m_dispatcher.Register("gateway.tools.sequenceScopeId", [this](const protocol::RequestFrame& request) {
			const auto tools = m_toolRegistry.List();
			return protocol::ResponseFrame{
				.id = request.id,
				.ok = true,
				.payloadJson = "{\"sequenceScopedId\":0,\"fallback\":0,\"tools\":" + std::to_string(tools.size()) + "}",
				.error = std::nullopt,
			};
			});

		m_dispatcher.Register("gateway.models.sequenceScopeId", [](const protocol::RequestFrame& request) {
			return protocol::ResponseFrame{
				.id = request.id,
				.ok = true,
				.payloadJson = "{\"models\":[\"default\",\"reasoner\"],\"count\":2}",
		...
		m_dispatcher.Register("gateway.config.sequenceScopeId", [](const protocol::RequestFrame& request) {
			return protocol::ResponseFrame{
				.id = request.id,
				.ok = true,
				.payloadJson = "{\"sections\":[\"gateway\",\"agent\"],\"count\":2}",
		...
		m_dispatcher.Register("gateway.transport.policy.sequenceScopeId", [this](const protocol::RequestFrame& request) {
			return protocol::ResponseFrame{
				.id = request.id,
				.ok = true,
				.payloadJson = "{\"sequenceScopeScopedId\":false,\"version\":1,\"applied\":false}",
				.error = std::nullopt,
			};
			});

		m_dispatcher.Register("gateway.tools.streamScopeId", [this](const protocol::RequestFrame& request) {
			const auto tools = m_toolRegistry.List();
			return protocol::ResponseFrame{
				.id = request.id,
				.ok = true,
				.payloadJson = "{\"streamScopedId\":0,\"fallback\":0,\"tools\":" + std::to_string(tools.size()) + "}",
				.error = std::nullopt,
			};
			});

		m_dispatcher.Register("gateway.models.streamScopeId", [](const protocol::RequestFrame& request) {
			return protocol::ResponseFrame{
				.id = request.id,
				.ok = true,
				.payloadJson = "{\"models\":[\"default\",\"reasoner\"],\"count\":2}",
		...
		m_dispatcher.Register("gateway.config.streamScopeId", [](const protocol::RequestFrame& request) {
			return protocol::ResponseFrame{
				.id = request.id,
				.ok = true,
				.payloadJson = "{\"sections\":[\"gateway\",\"agent\"],\"count\":2}",
		...
		m_dispatcher.Register("gateway.transport.policy.streamScopeId", [this](const protocol::RequestFrame& request) {
			return protocol::ResponseFrame{
				.id = request.id,
				.ok = true,
				.payloadJson = "{\"streamScopeScopedId\":false,\"version\":1,\"applied\":false}",
				.error = std::nullopt,
			};
			});

		m_dispatcher.Register("gateway.tools.bundleScopeId", [this](const protocol::RequestFrame& request) {
			const auto tools = m_toolRegistry.List();
			return protocol::ResponseFrame{
				.id = request.id,
				.ok = true,
				.payloadJson = "{\"bundleScopedId\":0,\"fallback\":0,\"tools\":" + std::to_string(tools.size()) + "}",
				.error = std::nullopt,
			};
			});

		m_dispatcher.Register("gateway.models.bundleScopeId", [](const protocol::RequestFrame& request) {
			return protocol::ResponseFrame{
				.id = request.id,
				.ok = true,
				.payloadJson = "{\"models\":[\"default\",\"reasoner\"],\"count\":2}",
		...
		m_dispatcher.Register("gateway.config.bundleScopeId", [](const protocol::RequestFrame& request) {
			return protocol::ResponseFrame{
				.id = request.id,
				.ok = true,
				.payloadJson = "{\"sections\":[\"gateway\",\"agent\"],\"count\":2}",
		...
		m_dispatcher.Register("gateway.transport.policy.bundleScopeId", [this](const protocol::RequestFrame& request) {
			return protocol::ResponseFrame{
				.id = request.id,
				.ok = true,
				.payloadJson = "{\"bundleScopeScopedId\":false,\"version\":1,\"applied\":false}",
				.error = std::nullopt,
			};
			});

		m_dispatcher.Register("gateway.tools.packageScopeId", [this](const protocol::RequestFrame& request) {
			const auto tools = m_toolRegistry.List();
			return protocol::ResponseFrame{
				.id = request.id,
				.ok = true,
				.payloadJson = "{\"packageScopedId\":0,\"fallback\":0,\"tools\":" + std::to_string(tools.size()) + "}",
				.error = std::nullopt,
			};
			});

		m_dispatcher.Register("gateway.models.packageScopeId", [](const protocol::RequestFrame& request) {
			return protocol::ResponseFrame{
				.id = request.id,
				.ok = true,
				.payloadJson = "{\"models\":[\"default\",\"reasoner\"],\"count\":2}",
		...
		m_dispatcher.Register("gateway.config.packageScopeId", [](const protocol::RequestFrame& request) {
			return protocol::ResponseFrame{
				.id = request.id,
				.ok = true,
				.payloadJson = "{\"sections\":[\"gateway\",\"agent\"],\"count\":2}",
		...
		m_dispatcher.Register("gateway.transport.policy.packageScopeId", [this](const protocol::RequestFrame& request) {
			return protocol::ResponseFrame{
				.id = request.id,
				.ok = true,
				.payloadJson = "{\"packageScopeScopedId\":false,\"version\":1,\"applied\":false}",
				.error = std::nullopt,
			};
			});

		m_dispatcher.Register("gateway.tools.archiveScopeId", [this](const protocol::RequestFrame& request) {
			const auto tools = m_toolRegistry.List();
			return protocol::ResponseFrame{
				.id = request.id,
				.ok = true,
				.payloadJson = "{\"archiveScopedId\":0,\"fallback\":0,\"tools\":" + std::to_string(tools.size()) + "}",
				.error = std::nullopt,
			};
			});

		m_dispatcher.Register("gateway.models.archiveScopeId", [](const protocol::RequestFrame& request) {
			return protocol::ResponseFrame{
				.id = request.id,
				.ok = true,
				.payloadJson = "{\"models\":[\"default\",\"reasoner\"],\"count\":2}",
		...
		m_dispatcher.Register("gateway.config.archiveScopeId", [](const protocol::RequestFrame& request) {
			return protocol::ResponseFrame{
				.id = request.id,
				.ok = true,
				.payloadJson = "{\"sections\":[\"gateway\",\"agent\"],\"count\":2}",
		...
		m_dispatcher.Register("gateway.transport.policy.archiveScopeId", [this](const protocol::RequestFrame& request) {
			return protocol::ResponseFrame{
				.id = request.id,
				.ok = true,
				.payloadJson = "{\"archiveScopeScopedId\":false,\"version\":1,\"applied\":false}",
				.error = std::nullopt,
			};
			});

		m_dispatcher.Register("gateway.tools.manifestScopeId", [this](const protocol::RequestFrame& request) {
			const auto tools = m_toolRegistry.List();
			return protocol::ResponseFrame{
				.id = request.id,
				.ok = true,
				.payloadJson = "{\"manifestScopedId\":0,\"fallback\":0,\"tools\":" + std::to_string(tools.size()) + "}",
				.error = std::nullopt,
			};
			});

		m_dispatcher.Register("gateway.models.manifestScopeId", [](const protocol::RequestFrame& request) {
			return protocol::ResponseFrame{
				.id = request.id,
				.ok = true,
				.payloadJson = "{\"models\":[\"default\",\"reasoner\"],\"count\":2}",
		...
		m_dispatcher.Register("gateway.config.manifestScopeId", [](const protocol::RequestFrame& request) {
			return protocol::ResponseFrame{
				.id = request.id,
				.ok = true,
				.payloadJson = "{\"sections\":[\"gateway\",\"agent\"],\"count\":2}",
		...
		m_dispatcher.Register("gateway.transport.policy.manifestScopeId", [this](const protocol::RequestFrame& request) {
			return protocol::ResponseFrame{
				.id = request.id,
				.ok = true,
				.payloadJson = "{\"manifestScopeScopedId\":false,\"version\":1,\"applied\":false}",
				.error = std::nullopt,
			};
			});

		m_dispatcher.Register("gateway.tools.profileScopeId", [this](const protocol::RequestFrame& request) {
			const auto tools = m_toolRegistry.List();
			return protocol::ResponseFrame{
				.id = request.id,
				.ok = true,
				.payloadJson = "{\"profileScopedId\":0,\"fallback\":0,\"tools\":" + std::to_string(tools.size()) + "}",
				.error = std::nullopt,
			};
			});

		m_dispatcher.Register("gateway.models.profileScopeId", [](const protocol::RequestFrame& request) {
			return protocol::ResponseFrame{
				.id = request.id,
				.ok = true,
				.payloadJson = "{\"models\":[\"default\",\"reasoner\"],\"count\":2}",
		...
		m_dispatcher.Register("gateway.config.profileScopeId", [](const protocol::RequestFrame& request) {
			return protocol::ResponseFrame{
				.id = request.id,
				.ok = true,
				.payloadJson = "{\"sections\":[\"gateway\",\"agent\"],\"count\":2}",
		...
		m_dispatcher.Register("gateway.transport.policy.profileScopeId", [this](const protocol::RequestFrame& request) {
			return protocol::ResponseFrame{
				.id = request.id,
				.ok = true,
				.payloadJson = "{\"profileScopeScopedId\":false,\"version\":1,\"applied\":false}",
				.error = std::nullopt,
			};
			});

		m_dispatcher.Register("gateway.tools.templateScopeId", [this](const protocol::RequestFrame& request) {
			const auto tools = m_toolRegistry.List();
			return protocol::ResponseFrame{
				.id = request.id,
				.ok = true,
				.payloadJson = "{\"templateScopedId\":0,\"fallback\":0,\"tools\":" + std::to_string(tools.size()) + "}",
				.error = std::nullopt,
			};
			});

		m_dispatcher.Register("gateway.models.templateScopeId", [](const protocol::RequestFrame& request) {
			return protocol::ResponseFrame{
				.id = request.id,
				.ok = true,
				.payloadJson = "{\"models\":[\"default\",\"reasoner\"],\"count\":2}",
		...
		m_dispatcher.Register("gateway.config.templateScopeId", [](const protocol::RequestFrame& request) {
			return protocol::ResponseFrame{
				.id = request.id,
				.ok = true,
				.payloadJson = "{\"sections\":[\"gateway\",\"agent\"],\"count\":2}",
		...
		m_dispatcher.Register("gateway.transport.policy.templateScopeId", [this](const protocol::RequestFrame& request) {
			return protocol::ResponseFrame{
				.id = request.id,
				.ok = true,
				.payloadJson = "{\"templateScopeScopedId\":false,\"version\":1,\"applied\":false}",
				.error = std::nullopt,
			};
			});

		m_dispatcher.Register("gateway.tools.revisionScopeId", [this](const protocol::RequestFrame& request) {
			const auto tools = m_toolRegistry.List();
			return protocol::ResponseFrame{
				.id = request.id,
				.ok = true,
				.payloadJson = "{\"revisionScopedId\":0,\"fallback\":0,\"tools\":" + std::to_string(tools.size()) + "}",
				.error = std::nullopt,
			};
			});

		m_dispatcher.Register("gateway.models.revisionScopeId", [](const protocol::RequestFrame& request) {
			return protocol::ResponseFrame{
				.id = request.id,
				.ok = true,
				.payloadJson = "{\"models\":[\"default\",\"reasoner\"],\"count\":2}",
		...
		m_dispatcher.Register("gateway.config.revisionScopeId", [](const protocol::RequestFrame& request) {
			return protocol::ResponseFrame{
				.id = request.id,
				.ok = true,
				.payloadJson = "{\"sections\":[\"gateway\",\"agent\"],\"count\":2}",
		...
		m_dispatcher.Register("gateway.transport.policy.revisionScopeId", [this](const protocol::RequestFrame& request) {
			return protocol::ResponseFrame{
				.id = request.id,
				.ok = true,
				.payloadJson = "{\"revisionScopeScopedId\":false,\"version\":1,\"applied\":false}",
				.error = std::nullopt,
			};
			});

		m_dispatcher.Register("gateway.tools.historyScopeId", [this](const protocol::RequestFrame& request) {
			const auto tools = m_toolRegistry.List();
			return protocol::ResponseFrame{
				.id = request.id,
				.ok = true,
				.payloadJson = "{\"historyScopedId\":0,\"fallback\":0,\"tools\":" + std::to_string(tools.size()) + "}",
				.error = std::nullopt,
			};
			});

		m_dispatcher.Register("gateway.models.historyScopeId", [](const protocol::RequestFrame& request) {
			return protocol::ResponseFrame{
				.id = request.id,
				.ok = true,
				.payloadJson = "{\"models\":[\"default\",\"reasoner\"],\"count\":2}",
		...
		m_dispatcher.Register("gateway.config.historyScopeId", [](const protocol::RequestFrame& request) {
			return protocol::ResponseFrame{
				.id = request.id,
				.ok = true,
				.payloadJson = "{\"sections\":[\"gateway\",\"agent\"],\"count\":2}",
		...
		m_dispatcher.Register("gateway.transport.policy.historyScopeId", [this](const protocol::RequestFrame& request) {
			return protocol::ResponseFrame{
				.id = request.id,
				.ok = true,
				.payloadJson = "{\"historyScopeScopedId\":false,\"version\":1,\"applied\":false}",
				.error = std::nullopt,
			};
			});

		m_dispatcher.Register("gateway.tools.snapshotScopeId", [this](const protocol::RequestFrame& request) {
			const auto tools = m_toolRegistry.List();
			return protocol::ResponseFrame{
				.id = request.id,
				.ok = true,
				.payloadJson = "{\"snapshotScopedId\":0,\"fallback\":0,\"tools\":" + std::to_string(tools.size()) + "}",
				.error = std::nullopt,
			};
			});

		m_dispatcher.Register("gateway.models.snapshotScopeId", [](const protocol::RequestFrame& request) {
			return protocol::ResponseFrame{
				.id = request.id,
				.ok = true,
				.payloadJson = "{\"models\":[\"default\",\"reasoner\"],\"count\":2}",
		...
		m_dispatcher.Register("gateway.config.snapshotScopeId", [](const protocol::RequestFrame& request) {
			return protocol::ResponseFrame{
				.id = request.id,
				.ok = true,
				.payloadJson = "{\"sections\":[\"gateway\",\"agent\"],\"count\":2}",
		...
		m_dispatcher.Register("gateway.transport.policy.snapshotScopeId", [this](const protocol::RequestFrame& request) {
			return protocol::ResponseFrame{
				.id = request.id,
				.ok = true,
				.payloadJson = "{\"snapshotScopeScopedId\":false,\"version\":1,\"applied\":false}",
				.error = std::nullopt,
			};
			});

		m_dispatcher.Register("gateway.tools.indexScopeId", [this](const protocol::RequestFrame& request) {
			const auto tools = m_toolRegistry.List();
			return protocol::ResponseFrame{
				.id = request.id,
				.ok = true,
				.payloadJson = "{\"indexScopedId\":0,\"fallback\":0,\"tools\":" + std::to_string(tools.size()) + "}",
				.error = std::nullopt,
			};
			});

		m_dispatcher.Register("gateway.models.indexScopeId", [](const protocol::RequestFrame& request) {
			return protocol::ResponseFrame{
				.id = request.id,
				.ok = true,
				.payloadJson = "{\"models\":[\"default\",\"reasoner\"],\"count\":2}",
		...
		m_dispatcher.Register("gateway.config.indexScopeId", [](const protocol::RequestFrame& request) {
			return protocol::ResponseFrame{
				.id = request.id,
				.ok = true,
				.payloadJson = "{\"sections\":[\"gateway\",\"agent\"],\"count\":2}",
		...
		m_dispatcher.Register("gateway.transport.policy.indexScopeId", [this](const protocol::RequestFrame& request) {
			return protocol::ResponseFrame{
				.id = request.id,
				.ok = true,
				.payloadJson = "{\"indexScopeScopedId\":false,\"version\":1,\"applied\":false}",
				.error = std::nullopt,
			};
			});

		m_dispatcher.Register("gateway.tools.markerScopeId", [this](const protocol::RequestFrame& request) {
			const auto tools = m_toolRegistry.List();
			return protocol::ResponseFrame{
				.id = request.id,
				.ok = true,
				.payloadJson = "{\"markerScopedId\":0,\"fallback\":0,\"tools\":" + std::to_string(tools.size()) + "}",
				.error = std::nullopt,
			};
			});

		m_dispatcher.Register("gateway.models.markerScopeId", [](const protocol::RequestFrame& request) {
			return protocol::ResponseFrame{
				.id = request.id,
				.ok = true,
				.payloadJson = "{\"models\":[\"default\",\"reasoner\"],\"count\":2}",
		...
		m_dispatcher.Register("gateway.config.markerScopeId", [](const protocol::RequestFrame& request) {
			return protocol::ResponseFrame{
				.id = request.id,
				.ok = true,
				.payloadJson = "{\"sections\":[\"gateway\",\"agent\"],\"count\":2}",
		...
		m_dispatcher.Register("gateway.transport.policy.markerScopeId", [this](const protocol::RequestFrame& request) {
			return protocol::ResponseFrame{
				.id = request.id,
				.ok = true,
				.payloadJson = "{\"markerScopeScopedId\":false,\"version\":1,\"applied\":false}",
				.error = std::nullopt,
			};
			});
		...
		m_dispatcher.Register("gateway.runtime.streaming.backpressure", [](const protocol::RequestFrame& request) {
			return protocol::ResponseFrame{
				.id = request.id,
				.ok = true,
				.payloadJson = "{\"pressure\":0,\"throttled\":false,\"bufferedFrames\":0}",
				.error = std::nullopt,
			};
			});
		...
		m_dispatcher.Register("gateway.models.failover.simulate", [](const protocol::RequestFrame& request) {
			return protocol::ResponseFrame{
				.id = request.id,
				.ok = true,
				.payloadJson = "{\"requested\":\"default\",\"resolved\":\"default\",\"usedFallback\":false}",
				.error = std::nullopt,
			};
			});
		...
		m_dispatcher.Register("gateway.runtime.orchestration.drain", [](const protocol::RequestFrame& request) {
			return protocol::ResponseFrame{
				.id = request.id,
				.ok = true,
				.payloadJson = "{\"drained\":0,\"remaining\":0,\"reason\":\"idle\"}",
				.error = std::nullopt,
			};
			});
		...
		m_dispatcher.Register("gateway.runtime.streaming.replay", [](const protocol::RequestFrame& request) {
			return protocol::ResponseFrame{
				.id = request.id,
				.ok = true,
				.payloadJson = "{\"replayed\":2,\"cursor\":\"stream-cursor-1\",\"complete\":true}",
				.error = std::nullopt,
			};
			});
		...
		m_dispatcher.Register("gateway.models.failover.audit", [](const protocol::RequestFrame& request) {
			return protocol::ResponseFrame{
				.id = request.id,
				.ok = true,
				.payloadJson = "{\"entries\":2,\"lastModel\":\"default\",\"lastOutcome\":\"primary\"}",
				.error = std::nullopt,
			};
			});
