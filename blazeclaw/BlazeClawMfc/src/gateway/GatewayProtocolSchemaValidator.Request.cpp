...
namespace blazeclaw::gateway::protocol {
	...
	bool GatewayProtocolSchemaValidator::ValidateRequest(const RequestFrame& request, SchemaValidationIssue& issue) {
		...
		static const std::unordered_set<std::string> noParamsMethods = {
			...
			"gateway.models.failover.simulate", "gateway.runtime.orchestration.drain", "gateway.runtime.streaming.replay",
			"gateway.models.failover.audit", "gateway.runtime.orchestration.snapshot", "gateway.runtime.streaming.cursor",
			"gateway.models.failover.policy", "gateway.runtime.orchestration.timeline", "gateway.runtime.streaming.metrics",
			"gateway.models.failover.history", "gateway.runtime.orchestration.heartbeat", "gateway.runtime.streaming.health",
			"gateway.models.failover.recent", "gateway.channels.adapters.list", "gateway.tools.executions.list",
			"gateway.tools.executions.count", "gateway.tools.executions.latest", "gateway.tools.executions.clear",
			"gateway.runtime.orchestration.pulse", "gateway.runtime.streaming.snapshot", "gateway.models.failover.window",
			"gateway.runtime.orchestration.cadence", "gateway.runtime.streaming.watermark", "gateway.models.failover.digest",
			"gateway.runtime.orchestration.beacon", "gateway.runtime.streaming.checkpoint", "gateway.models.failover.ledger",
			"gateway.runtime.orchestration.epoch", "gateway.runtime.streaming.resume", "gateway.models.failover.profile",
			...
			"gateway.runtime.orchestration.mesh", "gateway.runtime.streaming.fidelity", "gateway.models.failover.margin",
			"gateway.runtime.orchestration.fabric", "gateway.runtime.streaming.accuracy", "gateway.models.failover.reserve",
			"gateway.runtime.orchestration.load", "gateway.runtime.streaming.buffer", "gateway.models.failover.override",
			"gateway.runtime.orchestration.saturation", "gateway.runtime.streaming.throttle", "gateway.models.failover.override.clear",
			"gateway.runtime.orchestration.pressure", "gateway.runtime.streaming.pacing", "gateway.models.failover.override.status",
			"gateway.runtime.orchestration.headroom", "gateway.runtime.streaming.jitter", "gateway.models.failover.override.history",
			"gateway.runtime.orchestration.balance", "gateway.runtime.streaming.drift", "gateway.models.failover.override.metrics",
			"gateway.runtime.orchestration.efficiency", "gateway.runtime.streaming.variance", "gateway.models.failover.override.window",
			...
			"gateway.runtime.orchestration.cohesion", "gateway.runtime.streaming.curvature", "gateway.models.failover.override.matrix",
			"gateway.runtime.orchestration.resilience", "gateway.runtime.streaming.smoothness", "gateway.models.failover.override.snapshot",
			"gateway.runtime.orchestration.readiness", "gateway.runtime.streaming.harmonics", "gateway.models.failover.override.pointer",
			"gateway.runtime.orchestration.contention", "gateway.runtime.streaming.phase", "gateway.models.failover.override.state",
			"gateway.runtime.orchestration.fairness", "gateway.runtime.streaming.tempo", "gateway.models.failover.override.profile",
			"gateway.runtime.orchestration.equilibrium", "gateway.runtime.orchestration.steadiness",
			"gateway.runtime.streaming.temporal", "gateway.runtime.streaming.consistency",
			"gateway.models.failover.override.audit",
			"gateway.runtime.orchestration.parity", "gateway.runtime.orchestration.stabilityIndex",
			"gateway.runtime.streaming.spectral", "gateway.runtime.streaming.envelope",
			"gateway.models.failover.override.checkpoint",
			"gateway.runtime.orchestration.convergence", "gateway.runtime.orchestration.hysteresis",
			"gateway.runtime.streaming.resonance", "gateway.runtime.streaming.vectorField",
			"gateway.models.failover.override.baseline",
			"gateway.runtime.orchestration.balanceIndex", "gateway.runtime.orchestration.phaseLock",
			"gateway.runtime.streaming.waveform", "gateway.runtime.streaming.horizon",
			"gateway.models.failover.override.manifest",
			"gateway.runtime.orchestration.symmetry", "gateway.runtime.orchestration.gradient",
			"gateway.runtime.streaming.vectorClock", "gateway.runtime.streaming.trend",
			"gateway.models.failover.override.ledger",
			"gateway.runtime.orchestration.harmonicity", "gateway.runtime.orchestration.inertia",
			"gateway.runtime.streaming.coordination", "gateway.runtime.streaming.latencyBand",
			"gateway.models.failover.override.snapshotIndex",
			"gateway.runtime.orchestration.cadenceIndex", "gateway.runtime.orchestration.damping",
			"gateway.runtime.streaming.phaseNoise", "gateway.runtime.streaming.beat",
			"gateway.models.failover.override.digestIndex",
			"gateway.runtime.orchestration.waveLock", "gateway.runtime.orchestration.flux",
			"gateway.runtime.orchestration.vectorField", "gateway.runtime.orchestration.phaseEnvelope",
			"gateway.runtime.orchestration.vectorDrift", "gateway.runtime.orchestration.phaseBias",
			"gateway.runtime.orchestration.vectorPhase", "gateway.runtime.orchestration.biasDrift",
			"gateway.runtime.orchestration.phaseVector", "gateway.runtime.orchestration.biasEnvelope",
			"gateway.runtime.orchestration.phaseMatrix", "gateway.runtime.orchestration.driftEnvelope",
			"gateway.runtime.orchestration.phaseLattice", "gateway.runtime.orchestration.envelopeDrift",
			"gateway.runtime.orchestration.phaseContour", "gateway.runtime.orchestration.driftVector",
			"gateway.runtime.orchestration.phaseRibbon", "gateway.runtime.orchestration.vectorEnvelope",
			"gateway.runtime.orchestration.phaseHelix", "gateway.runtime.orchestration.vectorContour",
			"gateway.runtime.orchestration.phaseSpiral", "gateway.runtime.orchestration.vectorRibbon",
			"gateway.runtime.orchestration.phaseArc", "gateway.runtime.orchestration.vectorSpiral",
			"gateway.runtime.orchestration.phaseMesh", "gateway.runtime.orchestration.vectorArc",
			"gateway.runtime.orchestration.phaseFabric", "gateway.runtime.orchestration.vectorMesh",
			"gateway.runtime.orchestration.phaseNet", "gateway.runtime.orchestration.vectorNode",
			"gateway.runtime.orchestration.phaseCore", "gateway.runtime.orchestration.vectorCore",
			"gateway.runtime.orchestration.phaseFrame", "gateway.runtime.orchestration.vectorFrame",
			"gateway.runtime.orchestration.phaseSpan", "gateway.runtime.orchestration.vectorSpan",
			"gateway.runtime.orchestration.phaseGrid", "gateway.runtime.orchestration.vectorGrid",
			"gateway.runtime.orchestration.phaseLane", "gateway.runtime.orchestration.vectorLane",
			"gateway.runtime.orchestration.phaseTrack", "gateway.runtime.orchestration.vectorTrack",
			"gateway.runtime.orchestration.phaseRail", "gateway.runtime.orchestration.vectorRail",
			"gateway.runtime.orchestration.phaseSpline", "gateway.runtime.orchestration.vectorSpline",
			"gateway.runtime.orchestration.phaseChain", "gateway.runtime.orchestration.vectorChain",
			"gateway.runtime.orchestration.phaseThread", "gateway.runtime.orchestration.vectorThread",
			"gateway.runtime.orchestration.phaseLink", "gateway.runtime.orchestration.vectorLink",
			"gateway.runtime.orchestration.phaseNode", "gateway.runtime.orchestration.vectorNode2",
			"gateway.runtime.orchestration.phaseBridge", "gateway.runtime.orchestration.vectorBridge",
			"gateway.runtime.orchestration.phaseAnchor2", "gateway.runtime.orchestration.vectorAnchor2",
			"gateway.runtime.orchestration.phasePortal", "gateway.runtime.orchestration.vectorPortal",
			"gateway.runtime.orchestration.phaseRelay2", "gateway.runtime.orchestration.vectorRelay2",
			"gateway.runtime.orchestration.phaseGate2", "gateway.runtime.orchestration.vectorGate2",
			"gateway.runtime.orchestration.phaseHub2", "gateway.runtime.orchestration.vectorHub2",
			"gateway.runtime.orchestration.phaseNode3", "gateway.runtime.orchestration.vectorNode3",
			"gateway.runtime.orchestration.phaseLink2", "gateway.runtime.orchestration.vectorLink2",
			"gateway.runtime.orchestration.phaseMesh2", "gateway.runtime.orchestration.vectorMesh2",
			"gateway.runtime.orchestration.phaseArc2", "gateway.runtime.orchestration.vectorArc2",
			"gateway.runtime.orchestration.phaseBand2", "gateway.runtime.orchestration.vectorBand2",
			"gateway.runtime.orchestration.phaseGrid2", "gateway.runtime.orchestration.vectorGrid2",
			"gateway.runtime.orchestration.phaseLane2", "gateway.runtime.orchestration.vectorLane2",
			"gateway.runtime.orchestration.phaseTrack2", "gateway.runtime.orchestration.vectorTrack2",
			"gateway.runtime.orchestration.phaseRail2", "gateway.runtime.orchestration.vectorRail2",
			"gateway.runtime.orchestration.phaseSpline2", "gateway.runtime.orchestration.vectorSpline2",
			"gateway.runtime.orchestration.phaseChain2", "gateway.runtime.orchestration.vectorChain2",
			"gateway.runtime.orchestration.phaseThread2", "gateway.runtime.orchestration.vectorThread2",
			"gateway.runtime.orchestration.phaseLink3", "gateway.runtime.orchestration.vectorLink3",
			"gateway.runtime.orchestration.phaseNode4", "gateway.runtime.orchestration.vectorNode4",
			"gateway.runtime.orchestration.phaseMesh3", "gateway.runtime.orchestration.vectorMesh3",
			"gateway.runtime.orchestration.phaseBridge3", "gateway.runtime.orchestration.vectorBridge3",
			"gateway.runtime.orchestration.phasePortal3", "gateway.runtime.orchestration.vectorPortal3",
			"gateway.runtime.orchestration.phaseRelay3", "gateway.runtime.orchestration.vectorRelay3",
			"gateway.runtime.orchestration.phaseGate3", "gateway.runtime.orchestration.vectorGate3",
			"gateway.runtime.orchestration.phaseHub3", "gateway.runtime.orchestration.vectorHub3",
			"gateway.runtime.orchestration.phaseNode5", "gateway.runtime.orchestration.vectorNode5",
			"gateway.runtime.orchestration.phaseLink4", "gateway.runtime.orchestration.vectorLink4",
			"gateway.runtime.orchestration.phaseBridge4", "gateway.runtime.orchestration.vectorBridge4",
			"gateway.runtime.orchestration.phasePortal4", "gateway.runtime.orchestration.vectorPortal4",
			"gateway.runtime.orchestration.phaseGate4", "gateway.runtime.orchestration.vectorGate4",
			"gateway.runtime.streaming.modulation", "gateway.runtime.streaming.pulseTrain",
			"gateway.runtime.streaming.cohesion", "gateway.runtime.streaming.waveIndex",
			"gateway.runtime.streaming.syncBand", "gateway.runtime.streaming.waveDrift",
			"gateway.runtime.streaming.syncDrift", "gateway.runtime.streaming.bandStability",
			"gateway.runtime.streaming.syncEnvelope", "gateway.runtime.streaming.bandDrift",
			"gateway.runtime.streaming.syncVector", "gateway.runtime.streaming.bandEnvelope",
			"gateway.runtime.streaming.syncMatrix", "gateway.runtime.streaming.bandVector",
			"gateway.runtime.streaming.syncContour", "gateway.runtime.streaming.bandMatrix",
			"gateway.runtime.streaming.syncRibbon", "gateway.runtime.streaming.bandContour",
			"gateway.runtime.streaming.syncHelix", "gateway.runtime.streaming.bandRibbon",
			"gateway.runtime.streaming.syncSpiral", "gateway.runtime.streaming.bandHelix",
			"gateway.runtime.streaming.syncArc", "gateway.runtime.streaming.bandSpiral",
			"gateway.runtime.streaming.syncMesh", "gateway.runtime.streaming.bandLattice",
			"gateway.runtime.streaming.syncFabric", "gateway.runtime.streaming.bandArc",
			"gateway.runtime.streaming.syncNet", "gateway.runtime.streaming.bandNode",
			"gateway.runtime.streaming.syncCore", "gateway.runtime.streaming.bandCore",
			"gateway.runtime.streaming.syncFrame", "gateway.runtime.streaming.bandFrame",
			"gateway.runtime.streaming.syncSpan", "gateway.runtime.streaming.bandSpan",
			"gateway.runtime.streaming.syncGrid", "gateway.runtime.streaming.bandGrid",
			"gateway.runtime.streaming.syncLane", "gateway.runtime.streaming.bandLane",
			"gateway.runtime.streaming.syncTrack", "gateway.runtime.streaming.bandTrack",
			"gateway.runtime.streaming.syncRail", "gateway.runtime.streaming.bandRail",
			"gateway.runtime.streaming.syncSpline", "gateway.runtime.streaming.bandSpline",
			"gateway.runtime.streaming.syncChain", "gateway.runtime.streaming.bandChain",
			"gateway.runtime.streaming.syncThread", "gateway.runtime.streaming.bandThread",
			"gateway.runtime.streaming.syncLink", "gateway.runtime.streaming.bandLink",
			"gateway.runtime.streaming.syncNode2", "gateway.runtime.streaming.bandNode2",
			"gateway.runtime.streaming.syncBridge", "gateway.runtime.streaming.bandBridge",
			"gateway.runtime.streaming.syncAnchor2", "gateway.runtime.streaming.bandAnchor2",
			"gateway.runtime.streaming.syncPortal", "gateway.runtime.streaming.bandPortal",
			"gateway.runtime.streaming.syncRelay2", "gateway.runtime.streaming.bandRelay2",
			"gateway.runtime.streaming.syncGate2", "gateway.runtime.streaming.bandGate2",
			"gateway.runtime.streaming.syncHub2", "gateway.runtime.streaming.bandHub2",
			"gateway.runtime.streaming.syncNode3", "gateway.runtime.streaming.bandNode3",
			"gateway.runtime.streaming.syncLink2", "gateway.runtime.streaming.bandLink2",
			"gateway.runtime.streaming.syncMesh2", "gateway.runtime.streaming.bandMesh2",
			"gateway.runtime.streaming.syncArc2", "gateway.runtime.streaming.bandArc2",
			"gateway.runtime.streaming.syncBand2", "gateway.runtime.streaming.bandBand2",
			"gateway.runtime.streaming.syncGrid2", "gateway.runtime.streaming.bandGrid2",
			"gateway.runtime.streaming.syncLane2", "gateway.runtime.streaming.bandLane2",
			"gateway.runtime.streaming.syncTrack2", "gateway.runtime.streaming.bandTrack2",
			"gateway.runtime.streaming.syncRail2", "gateway.runtime.streaming.bandRail2",
			"gateway.runtime.streaming.syncSpline2", "gateway.runtime.streaming.bandSpline2",
			"gateway.runtime.streaming.syncChain2", "gateway.runtime.streaming.bandChain2",
			"gateway.runtime.streaming.syncThread2", "gateway.runtime.streaming.bandThread2",
			"gateway.runtime.streaming.syncLink3", "gateway.runtime.streaming.bandLink3",
			"gateway.runtime.streaming.syncNode4", "gateway.runtime.streaming.bandNode4",
			"gateway.runtime.streaming.syncMesh3", "gateway.runtime.streaming.bandMesh3",
			"gateway.runtime.streaming.syncBridge3", "gateway.runtime.streaming.bandBridge3",
			"gateway.runtime.streaming.syncPortal3", "gateway.runtime.streaming.bandPortal3",
			"gateway.runtime.streaming.syncRelay3", "gateway.runtime.streaming.bandRelay3",
			"gateway.runtime.streaming.syncGate3", "gateway.runtime.streaming.bandGate3",
			"gateway.runtime.streaming.syncHub3", "gateway.runtime.streaming.bandHub3",
			"gateway.runtime.streaming.syncNode5", "gateway.runtime.streaming.bandNode5",
			"gateway.runtime.streaming.syncLink4", "gateway.runtime.streaming.bandLink4",
			"gateway.runtime.streaming.syncBridge4", "gateway.runtime.streaming.bandBridge4",
			"gateway.runtime.streaming.syncPortal4", "gateway.runtime.streaming.bandPortal4",
			"gateway.runtime.streaming.syncGate4", "gateway.runtime.streaming.bandGate4",
			"gateway.models.failover.override.cursor", "gateway.models.failover.override.vector",
