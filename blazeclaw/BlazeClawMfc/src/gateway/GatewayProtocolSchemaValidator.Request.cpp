...
namespace blazeclaw::gateway::protocol {
	...
	bool GatewayProtocolSchemaValidator::ValidateRequest(const RequestFrame& request, SchemaValidationIssue& issue) {
		...
		static const std::unordered_set<std::string> noParamsMethods = {
            ...
            "gateway.transport.policy.snapshotScopeKey", "gateway.transport.policy.indexScopeKey", "gateway.logs.levels", "gateway.events.catalog", "gateway.events.list",
			...
			"gateway.events.snapshotScopeKey", "gateway.events.indexScopeKey", "gateway.models.list", "gateway.models.providers",
