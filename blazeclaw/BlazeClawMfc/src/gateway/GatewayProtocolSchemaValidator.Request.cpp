...
namespace blazeclaw::gateway::protocol {
	...
	bool GatewayProtocolSchemaValidator::ValidateRequest(const RequestFrame& request, SchemaValidationIssue& issue) {
		...
		static const std::unordered_set<std::string> noParamsMethods = {
          ...
          "gateway.runtime.orchestration.pulse", "gateway.runtime.streaming.snapshot",
			"gateway.models.failover.window",
          "gateway.runtime.orchestration.cadence", "gateway.runtime.streaming.watermark",
			"gateway.models.failover.digest",
          "gateway.runtime.orchestration.beacon", "gateway.runtime.streaming.checkpoint",
