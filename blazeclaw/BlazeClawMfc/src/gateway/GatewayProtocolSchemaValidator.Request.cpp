...
namespace blazeclaw::gateway::protocol {
	...
	bool GatewayProtocolSchemaValidator::ValidateRequest(const RequestFrame& request, SchemaValidationIssue& issue) {
		...
		static const std::unordered_set<std::string> noParamsMethods = {
			...
			"gateway.transport.policy.refresh", "gateway.logs.levels", "gateway.events.catalog", "gateway.events.list",
			...
			"gateway.events.stream", "gateway.models.list", "gateway.models.providers", "gateway.models.default.get",
			...
			"gateway.models.state", "gateway.tools.health", "gateway.tools.stats", "gateway.tools.failures",
			...
			"gateway.tools.selector", "gateway.tools.metrics", "gateway.tools.categories", "gateway.tools.catalog",
