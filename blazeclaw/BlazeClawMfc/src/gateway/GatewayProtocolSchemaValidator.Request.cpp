...
namespace blazeclaw::gateway::protocol {
	...
	bool GatewayProtocolSchemaValidator::ValidateRequest(const RequestFrame& request, SchemaValidationIssue& issue) {
		...
		static const std::unordered_set<std::string> noParamsMethods = {
            ...
            "gateway.transport.policy.refresh", "gateway.transport.policy.session", "gateway.transport.policy.scope", "gateway.transport.policy.context", "gateway.transport.policy.channel", "gateway.transport.policy.route", "gateway.transport.policy.account", "gateway.transport.policy.agent", "gateway.transport.policy.model", "gateway.transport.policy.config", "gateway.transport.policy.policy", "gateway.transport.policy.tool", "gateway.transport.policy.transport", "gateway.transport.policy.runtime", "gateway.transport.policy.stateKey", "gateway.logs.levels", "gateway.events.catalog", "gateway.events.list",
			...
			"gateway.events.stream", "gateway.events.sessionKey", "gateway.events.scopeKey", "gateway.events.contextKey", "gateway.events.channelKey", "gateway.events.routeKey", "gateway.events.accountKey", "gateway.events.agentKey", "gateway.events.modelKey", "gateway.events.configKey", "gateway.events.policyKey", "gateway.events.toolKey", "gateway.events.transportKey", "gateway.events.runtimeKey", "gateway.events.stateKey", "gateway.models.list", "gateway.models.providers", "gateway.models.default.get",
			...
			"gateway.models.state", "gateway.models.session", "gateway.models.scope", "gateway.models.context", "gateway.models.channel", "gateway.models.route", "gateway.models.account", "gateway.models.agent", "gateway.models.model", "gateway.models.config", "gateway.models.policy", "gateway.models.tool", "gateway.models.transport", "gateway.models.runtime", "gateway.models.stateKey", "gateway.tools.health", "gateway.tools.stats", "gateway.tools.failures",
			...
			"gateway.tools.selector", "gateway.tools.mapper", "gateway.tools.binding", "gateway.tools.profile", "gateway.tools.channel", "gateway.tools.route", "gateway.tools.account", "gateway.tools.agent", "gateway.tools.model", "gateway.tools.config", "gateway.tools.policy", "gateway.tools.tool", "gateway.tools.transport", "gateway.tools.runtime", "gateway.tools.state", "gateway.tools.metrics", "gateway.tools.categories", "gateway.tools.catalog",
