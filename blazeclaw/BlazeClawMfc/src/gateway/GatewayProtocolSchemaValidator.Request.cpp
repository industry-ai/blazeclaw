...
namespace blazeclaw::gateway::protocol {
	...
	bool GatewayProtocolSchemaValidator::ValidateRequest(const RequestFrame& request, SchemaValidationIssue& issue) {
		...
		static const std::unordered_set<std::string> noParamsMethods = {
			...
			"gateway.events.stream", "gateway.events.sessionKey", "gateway.events.scopeKey", "gateway.events.contextKey", "gateway.events.channelKey", "gateway.events.routeKey", "gateway.events.accountKey", "gateway.events.agentKey", "gateway.events.modelKey", "gateway.events.configKey", "gateway.events.policyKey", "gateway.models.list", "gateway.models.providers", "gateway.models.default.get",
