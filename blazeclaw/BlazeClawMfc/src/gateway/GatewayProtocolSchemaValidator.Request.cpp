...
namespace blazeclaw::gateway::protocol {
	...
	bool GatewayProtocolSchemaValidator::ValidateRequest(const RequestFrame& request, SchemaValidationIssue& issue) {
		...
		static const std::unordered_set<std::string> noParamsMethods = {
			...
			"gateway.config.historyScopeKey", "gateway.config.snapshotScopeKey",
			...
			"gateway.transport.policy.snapshotScopeKey", "gateway.logs.levels", "gateway.events.catalog", "gateway.events.list",
            ...
            "gateway.events.profileScopeKey", "gateway.events.templateScopeKey", "gateway.events.revisionScopeKey", "gateway.events.historyScopeKey", "gateway.events.snapshotScopeKey", "gateway.models.list", "gateway.models.providers",
