	...
	bool GatewayProtocolSchemaValidator::ValidateResponseForMethod(
		...
		const std::unordered_map<std::string, std::function<bool()>> groupedValidators = {
           ...
           { "gateway.runtime.orchestration.phaseMatrix", [&]() {
			...
			{ "gateway.runtime.orchestration.phaseThread", [&]() {
				if (!IsFieldNumber(payload, "phaseThread") || !IsFieldNumber(payload, "windowMs") || !IsFieldBoolean(payload, "stable")) {
					SetIssue(issue, "schema_invalid_response", "`gateway.runtime.orchestration.phaseThread` requires `phaseThread`, `windowMs`, and `stable` fields.");
					return false;
				}
				return true;
			} },
			{ "gateway.runtime.orchestration.vectorThread", [&]() {
				if (!IsFieldNumber(payload, "vectorThread") || !IsFieldNumber(payload, "windowMs") || !IsFieldBoolean(payload, "stable")) {
					SetIssue(issue, "schema_invalid_response", "`gateway.runtime.orchestration.vectorThread` requires `vectorThread`, `windowMs`, and `stable` fields.");
					return false;
				}
				return true;
            } },
			{ "gateway.runtime.orchestration.phaseLink", [&]() {
				if (!IsFieldNumber(payload, "phaseLink") || !IsFieldNumber(payload, "windowMs") || !IsFieldBoolean(payload, "stable")) {
					SetIssue(issue, "schema_invalid_response", "`gateway.runtime.orchestration.phaseLink` requires `phaseLink`, `windowMs`, and `stable` fields.");
					return false;
				}
				return true;
			} },
			{ "gateway.runtime.orchestration.vectorLink", [&]() {
				if (!IsFieldNumber(payload, "vectorLink") || !IsFieldNumber(payload, "windowMs") || !IsFieldBoolean(payload, "stable")) {
					SetIssue(issue, "schema_invalid_response", "`gateway.runtime.orchestration.vectorLink` requires `vectorLink`, `windowMs`, and `stable` fields.");
					return false;
				}
				return true;
            } },
			{ "gateway.runtime.orchestration.phaseNode", [&]() {
				if (!IsFieldNumber(payload, "phaseNode") || !IsFieldNumber(payload, "windowMs") || !IsFieldBoolean(payload, "stable")) {
					SetIssue(issue, "schema_invalid_response", "`gateway.runtime.orchestration.phaseNode` requires `phaseNode`, `windowMs`, and `stable` fields.");
					return false;
				}
				return true;
			} },
			{ "gateway.runtime.orchestration.vectorNode2", [&]() {
				if (!IsFieldNumber(payload, "vectorNode2") || !IsFieldNumber(payload, "windowMs") || !IsFieldBoolean(payload, "stable")) {
					SetIssue(issue, "schema_invalid_response", "`gateway.runtime.orchestration.vectorNode2` requires `vectorNode2`, `windowMs`, and `stable` fields.");
					return false;
				}
				return true;
            } },
			...
			{ "gateway.runtime.orchestration.phaseAnchor2", [&]() {
				if (!IsFieldNumber(payload, "phaseAnchor2") || !IsFieldNumber(payload, "windowMs") || !IsFieldBoolean(payload, "stable")) {
					SetIssue(issue, "schema_invalid_response", "`gateway.runtime.orchestration.phaseAnchor2` requires `phaseAnchor2`, `windowMs`, and `stable` fields.");
					return false;
				}
				return true;
			} },
			{ "gateway.runtime.orchestration.vectorAnchor2", [&]() {
				if (!IsFieldNumber(payload, "vectorAnchor2") || !IsFieldNumber(payload, "windowMs") || !IsFieldBoolean(payload, "stable")) {
					SetIssue(issue, "schema_invalid_response", "`gateway.runtime.orchestration.vectorAnchor2` requires `vectorAnchor2`, `windowMs`, and `stable` fields.");
					return false;
				}
				return true;
            } },
			{ "gateway.runtime.orchestration.phasePortal", [&]() {
				if (!IsFieldNumber(payload, "phasePortal") || !IsFieldNumber(payload, "windowMs") || !IsFieldBoolean(payload, "stable")) {
					SetIssue(issue, "schema_invalid_response", "`gateway.runtime.orchestration.phasePortal` requires `phasePortal`, `windowMs`, and `stable` fields.");
					return false;
				}
				return true;
			} },
			{ "gateway.runtime.orchestration.vectorPortal", [&]() {
				if (!IsFieldNumber(payload, "vectorPortal") || !IsFieldNumber(payload, "windowMs") || !IsFieldBoolean(payload, "stable")) {
					SetIssue(issue, "schema_invalid_response", "`gateway.runtime.orchestration.vectorPortal` requires `vectorPortal`, `windowMs`, and `stable` fields.");
					return false;
				}
				return true;
            } },
			...
			{ "gateway.runtime.orchestration.phaseGate2", [&]() {
				if (!IsFieldNumber(payload, "phaseGate2") || !IsFieldNumber(payload, "windowMs") || !IsFieldBoolean(payload, "stable")) {
					SetIssue(issue, "schema_invalid_response", "`gateway.runtime.orchestration.phaseGate2` requires `phaseGate2`, `windowMs`, and `stable` fields.");
					return false;
				}
				return true;
			} },
			{ "gateway.runtime.orchestration.vectorGate2", [&]() {
				if (!IsFieldNumber(payload, "vectorGate2") || !IsFieldNumber(payload, "windowMs") || !IsFieldBoolean(payload, "stable")) {
					SetIssue(issue, "schema_invalid_response", "`gateway.runtime.orchestration.vectorGate2` requires `vectorGate2`, `windowMs`, and `stable` fields.");
					return false;
				}
				return true;
            } },
			{ "gateway.runtime.orchestration.phaseHub2", [&]() {
				if (!IsFieldNumber(payload, "phaseHub2") || !IsFieldNumber(payload, "windowMs") || !IsFieldBoolean(payload, "stable")) {
					SetIssue(issue, "schema_invalid_response", "`gateway.runtime.orchestration.phaseHub2` requires `phaseHub2`, `windowMs`, and `stable` fields.");
					return false;
				}
				return true;
			} },
			{ "gateway.runtime.orchestration.vectorHub2", [&]() {
				if (!IsFieldNumber(payload, "vectorHub2") || !IsFieldNumber(payload, "windowMs") || !IsFieldBoolean(payload, "stable")) {
					SetIssue(issue, "schema_invalid_response", "`gateway.runtime.orchestration.vectorHub2` requires `vectorHub2`, `windowMs`, and `stable` fields.");
					return false;
				}
				return true;
            } },
			{ "gateway.runtime.orchestration.phaseNode3", [&]() {
				if (!IsFieldNumber(payload, "phaseNode3") || !IsFieldNumber(payload, "windowMs") || !IsFieldBoolean(payload, "stable")) {
					SetIssue(issue, "schema_invalid_response", "`gateway.runtime.orchestration.phaseNode3` requires `phaseNode3`, `windowMs`, and `stable` fields.");
					return false;
				}
				return true;
			} },
			{ "gateway.runtime.orchestration.vectorNode3", [&]() {
				if (!IsFieldNumber(payload, "vectorNode3") || !IsFieldNumber(payload, "windowMs") || !IsFieldBoolean(payload, "stable")) {
					SetIssue(issue, "schema_invalid_response", "`gateway.runtime.orchestration.vectorNode3` requires `vectorNode3`, `windowMs`, and `stable` fields.");
					return false;
				}
				return true;
            } },
			{ "gateway.runtime.orchestration.phaseLink2", [&]() {
				if (!IsFieldNumber(payload, "phaseLink2") || !IsFieldNumber(payload, "windowMs") || !IsFieldBoolean(payload, "stable")) {
					SetIssue(issue, "schema_invalid_response", "`gateway.runtime.orchestration.phaseLink2` requires `phaseLink2`, `windowMs`, and `stable` fields.");
					return false;
				}
				return true;
			} },
			{ "gateway.runtime.orchestration.vectorLink2", [&]() {
				if (!IsFieldNumber(payload, "vectorLink2") || !IsFieldNumber(payload, "windowMs") || !IsFieldBoolean(payload, "stable")) {
					SetIssue(issue, "schema_invalid_response", "`gateway.runtime.orchestration.vectorLink2` requires `vectorLink2`, `windowMs`, and `stable` fields.");
					return false;
				}
				return true;
            } },
			{ "gateway.runtime.orchestration.phaseMesh2", [&]() {
				if (!IsFieldNumber(payload, "phaseMesh2") || !IsFieldNumber(payload, "windowMs") || !IsFieldBoolean(payload, "stable")) {
					SetIssue(issue, "schema_invalid_response", "`gateway.runtime.orchestration.phaseMesh2` requires `phaseMesh2`, `windowMs`, and `stable` fields.");
					return false;
				}
				return true;
			} },
			{ "gateway.runtime.orchestration.vectorMesh2", [&]() {
				if (!IsFieldNumber(payload, "vectorMesh2") || !IsFieldNumber(payload, "windowMs") || !IsFieldBoolean(payload, "stable")) {
					SetIssue(issue, "schema_invalid_response", "`gateway.runtime.orchestration.vectorMesh2` requires `vectorMesh2`, `windowMs`, and `stable` fields.");
					return false;
				}
				return true;
            } },
			...
			{ "gateway.runtime.orchestration.phaseNode4", [&]() {
				if (!IsFieldNumber(payload, "phaseNode4") || !IsFieldNumber(payload, "windowMs") || !IsFieldBoolean(payload, "stable")) {
					SetIssue(issue, "schema_invalid_response", "`gateway.runtime.orchestration.phaseNode4` requires `phaseNode4`, `windowMs`, and `stable` fields.");
					return false;
				}
				return true;
			} },
			{ "gateway.runtime.orchestration.vectorNode4", [&]() {
				if (!IsFieldNumber(payload, "vectorNode4") || !IsFieldNumber(payload, "windowMs") || !IsFieldBoolean(payload, "stable")) {
					SetIssue(issue, "schema_invalid_response", "`gateway.runtime.orchestration.vectorNode4` requires `vectorNode4`, `windowMs`, and `stable` fields.");
					return false;
				}
				return true;
            } },
			...
			{ "gateway.runtime.orchestration.phaseBridge3", [&]() {
				if (!IsFieldNumber(payload, "phaseBridge3") || !IsFieldNumber(payload, "windowMs") || !IsFieldBoolean(payload, "stable")) {
					SetIssue(issue, "schema_invalid_response", "`gateway.runtime.orchestration.phaseBridge3` requires `phaseBridge3`, `windowMs`, and `stable` fields.");
					return false;
				}
				return true;
			} },
			{ "gateway.runtime.orchestration.vectorBridge3", [&]() {
				if (!IsFieldNumber(payload, "vectorBridge3") || !IsFieldNumber(payload, "windowMs") || !IsFieldBoolean(payload, "stable")) {
					SetIssue(issue, "schema_invalid_response", "`gateway.runtime.orchestration.vectorBridge3` requires `vectorBridge3`, `windowMs`, and `stable` fields.");
					return false;
				}
				return true;
            } },
			{ "gateway.runtime.orchestration.phasePortal3", [&]() {
				if (!IsFieldNumber(payload, "phasePortal3") || !IsFieldNumber(payload, "windowMs") || !IsFieldBoolean(payload, "stable")) {
					SetIssue(issue, "schema_invalid_response", "`gateway.runtime.orchestration.phasePortal3` requires `phasePortal3`, `windowMs`, and `stable` fields.");
					return false;
				}
				return true;
			} },
			{ "gateway.runtime.orchestration.vectorPortal3", [&]() {
				if (!IsFieldNumber(payload, "vectorPortal3") || !IsFieldNumber(payload, "windowMs") || !IsFieldBoolean(payload, "stable")) {
					SetIssue(issue, "schema_invalid_response", "`gateway.runtime.orchestration.vectorPortal3` requires `vectorPortal3`, `windowMs`, and `stable` fields.");
					return false;
				}
				return true;
            } },
			...
			{ "gateway.runtime.orchestration.phaseGate3", [&]() {
				if (!IsFieldNumber(payload, "phaseGate3") || !IsFieldNumber(payload, "windowMs") || !IsFieldBoolean(payload, "stable")) {
					SetIssue(issue, "schema_invalid_response", "`gateway.runtime.orchestration.phaseGate3` requires `phaseGate3`, `windowMs`, and `stable` fields.");
					return false;
				}
				return true;
			} },
			{ "gateway.runtime.orchestration.vectorGate3", [&]() {
				if (!IsFieldNumber(payload, "vectorGate3") || !IsFieldNumber(payload, "windowMs") || !IsFieldBoolean(payload, "stable")) {
					SetIssue(issue, "schema_invalid_response", "`gateway.runtime.orchestration.vectorGate3` requires `vectorGate3`, `windowMs`, and `stable` fields.");
					return false;
				}
				return true;
			} },
         ...
         { "gateway.runtime.streaming.cohesion", [&]() {
			...
			{ "gateway.runtime.streaming.syncThread", [&]() {
				if (!IsFieldNumber(payload, "syncThread") || !IsFieldNumber(payload, "samples") || !IsFieldBoolean(payload, "stable")) {
					SetIssue(issue, "schema_invalid_response", "`gateway.runtime.streaming.syncThread` requires `syncThread`, `samples`, and `stable` fields.");
					return false;
				}
				return true;
			} },
			{ "gateway.runtime.streaming.bandThread", [&]() {
				if (!IsFieldNumber(payload, "bandThread") || !IsFieldNumber(payload, "samples") || !IsFieldBoolean(payload, "stable")) {
					SetIssue(issue, "schema_invalid_response", "`gateway.runtime.streaming.bandThread` requires `bandThread`, `samples`, and `stable` fields.");
					return false;
				}
				return true;
            } },
			{ "gateway.runtime.streaming.syncLink", [&]() {
				if (!IsFieldNumber(payload, "syncLink") || !IsFieldNumber(payload, "samples") || !IsFieldBoolean(payload, "stable")) {
					SetIssue(issue, "schema_invalid_response", "`gateway.runtime.streaming.syncLink` requires `syncLink`, `samples`, and `stable` fields.");
					return false;
				}
				return true;
			} },
			{ "gateway.runtime.streaming.bandLink", [&]() {
				if (!IsFieldNumber(payload, "bandLink") || !IsFieldNumber(payload, "samples") || !IsFieldBoolean(payload, "stable")) {
					SetIssue(issue, "schema_invalid_response", "`gateway.runtime.streaming.bandLink` requires `bandLink`, `samples`, and `stable` fields.");
					return false;
				}
				return true;
            } },
			{ "gateway.runtime.streaming.syncNode2", [&]() {
				if (!IsFieldNumber(payload, "syncNode2") || !IsFieldNumber(payload, "samples") || !IsFieldBoolean(payload, "stable")) {
					SetIssue(issue, "schema_invalid_response", "`gateway.runtime.streaming.syncNode2` requires `syncNode2`, `samples`, and `stable` fields.");
					return false;
				}
				return true;
			} },
			{ "gateway.runtime.streaming.bandNode2", [&]() {
				if (!IsFieldNumber(payload, "bandNode2") || !IsFieldNumber(payload, "samples") || !IsFieldBoolean(payload, "stable")) {
					SetIssue(issue, "schema_invalid_response", "`gateway.runtime.streaming.bandNode2` requires `bandNode2`, `samples`, and `stable` fields.");
					return false;
				}
				return true;
            } },
			...
			{ "gateway.runtime.streaming.syncAnchor2", [&]() {
				if (!IsFieldNumber(payload, "syncAnchor2") || !IsFieldNumber(payload, "samples") || !IsFieldBoolean(payload, "stable")) {
					SetIssue(issue, "schema_invalid_response", "`gateway.runtime.streaming.syncAnchor2` requires `syncAnchor2`, `samples`, and `stable` fields.");
					return false;
				}
				return true;
			} },
			{ "gateway.runtime.streaming.bandAnchor2", [&]() {
				if (!IsFieldNumber(payload, "bandAnchor2") || !IsFieldNumber(payload, "samples") || !IsFieldBoolean(payload, "stable")) {
					SetIssue(issue, "schema_invalid_response", "`gateway.runtime.streaming.bandAnchor2` requires `bandAnchor2`, `samples`, and `stable` fields.");
					return false;
				}
				return true;
            } },
			{ "gateway.runtime.streaming.syncPortal", [&]() {
				if (!IsFieldNumber(payload, "syncPortal") || !IsFieldNumber(payload, "samples") || !IsFieldBoolean(payload, "stable")) {
					SetIssue(issue, "schema_invalid_response", "`gateway.runtime.streaming.syncPortal` requires `syncPortal`, `samples`, and `stable` fields.");
					return false;
				}
				return true;
			} },
			{ "gateway.runtime.streaming.bandPortal", [&]() {
				if (!IsFieldNumber(payload, "bandPortal") || !IsFieldNumber(payload, "samples") || !IsFieldBoolean(payload, "stable")) {
					SetIssue(issue, "schema_invalid_response", "`gateway.runtime.streaming.bandPortal` requires `bandPortal`, `samples`, and `stable` fields.");
					return false;
				}
				return true;
            } },
			...
			{ "gateway.runtime.streaming.syncGate2", [&]() {
				if (!IsFieldNumber(payload, "syncGate2") || !IsFieldNumber(payload, "samples") || !IsFieldBoolean(payload, "stable")) {
					SetIssue(issue, "schema_invalid_response", "`gateway.runtime.streaming.syncGate2` requires `syncGate2`, `samples`, and `stable` fields.");
					return false;
				}
				return true;
			} },
			{ "gateway.runtime.streaming.bandGate2", [&]() {
				if (!IsFieldNumber(payload, "bandGate2") || !IsFieldNumber(payload, "samples") || !IsFieldBoolean(payload, "stable")) {
					SetIssue(issue, "schema_invalid_response", "`gateway.runtime.streaming.bandGate2` requires `bandGate2`, `samples`, and `stable` fields.");
					return false;
				}
				return true;
            } },
			{ "gateway.runtime.streaming.syncHub2", [&]() {
				if (!IsFieldNumber(payload, "syncHub2") || !IsFieldNumber(payload, "samples") || !IsFieldBoolean(payload, "stable")) {
					SetIssue(issue, "schema_invalid_response", "`gateway.runtime.streaming.syncHub2` requires `syncHub2`, `samples`, and `stable` fields.");
					return false;
				}
				return true;
			} },
			{ "gateway.runtime.streaming.bandHub2", [&]() {
				if (!IsFieldNumber(payload, "bandHub2") || !IsFieldNumber(payload, "samples") || !IsFieldBoolean(payload, "stable")) {
					SetIssue(issue, "schema_invalid_response", "`gateway.runtime.streaming.bandHub2` requires `bandHub2`, `samples`, and `stable` fields.");
					return false;
				}
				return true;
            } },
			{ "gateway.runtime.streaming.syncNode3", [&]() {
				if (!IsFieldNumber(payload, "syncNode3") || !IsFieldNumber(payload, "samples") || !IsFieldBoolean(payload, "stable")) {
					SetIssue(issue, "schema_invalid_response", "`gateway.runtime.streaming.syncNode3` requires `syncNode3`, `samples`, and `stable` fields.");
					return false;
				}
				return true;
			} },
			{ "gateway.runtime.streaming.bandNode3", [&]() {
				if (!IsFieldNumber(payload, "bandNode3") || !IsFieldNumber(payload, "samples") || !IsFieldBoolean(payload, "stable")) {
					SetIssue(issue, "schema_invalid_response", "`gateway.runtime.streaming.bandNode3` requires `bandNode3`, `samples`, and `stable` fields.");
					return false;
				}
				return true;
            } },
			{ "gateway.runtime.streaming.syncLink2", [&]() {
				if (!IsFieldNumber(payload, "syncLink2") || !IsFieldNumber(payload, "samples") || !IsFieldBoolean(payload, "stable")) {
					SetIssue(issue, "schema_invalid_response", "`gateway.runtime.streaming.syncLink2` requires `syncLink2`, `samples`, and `stable` fields.");
					return false;
				}
				return true;
			} },
			{ "gateway.runtime.streaming.bandLink2", [&]() {
				if (!IsFieldNumber(payload, "bandLink2") || !IsFieldNumber(payload, "samples") || !IsFieldBoolean(payload, "stable")) {
					SetIssue(issue, "schema_invalid_response", "`gateway.runtime.streaming.bandLink2` requires `bandLink2`, `samples`, and `stable` fields.");
					return false;
				}
				return true;
            } },
			{ "gateway.runtime.streaming.syncMesh2", [&]() {
				if (!IsFieldNumber(payload, "syncMesh2") || !IsFieldNumber(payload, "samples") || !IsFieldBoolean(payload, "stable")) {
					SetIssue(issue, "schema_invalid_response", "`gateway.runtime.streaming.syncMesh2` requires `syncMesh2`, `samples`, and `stable` fields.");
					return false;
				}
				return true;
			} },
			{ "gateway.runtime.streaming.bandMesh2", [&]() {
				if (!IsFieldNumber(payload, "bandMesh2") || !IsFieldNumber(payload, "samples") || !IsFieldBoolean(payload, "stable")) {
					SetIssue(issue, "schema_invalid_response", "`gateway.runtime.streaming.bandMesh2` requires `bandMesh2`, `samples`, and `stable` fields.");
					return false;
				}
				return true;
            } },
			...
			{ "gateway.runtime.streaming.syncNode4", [&]() {
				if (!IsFieldNumber(payload, "syncNode4") || !IsFieldNumber(payload, "samples") || !IsFieldBoolean(payload, "stable")) {
					SetIssue(issue, "schema_invalid_response", "`gateway.runtime.streaming.syncNode4` requires `syncNode4`, `samples`, and `stable` fields.");
					return false;
				}
				return true;
			} },
			{ "gateway.runtime.streaming.bandNode4", [&]() {
				if (!IsFieldNumber(payload, "bandNode4") || !IsFieldNumber(payload, "samples") || !IsFieldBoolean(payload, "stable")) {
					SetIssue(issue, "schema_invalid_response", "`gateway.runtime.streaming.bandNode4` requires `bandNode4`, `samples`, and `stable` fields.");
					return false;
				}
				return true;
            } },
			...
			{ "gateway.runtime.streaming.syncBridge3", [&]() {
				if (!IsFieldNumber(payload, "syncBridge3") || !IsFieldNumber(payload, "samples") || !IsFieldBoolean(payload, "stable")) {
					SetIssue(issue, "schema_invalid_response", "`gateway.runtime.streaming.syncBridge3` requires `syncBridge3`, `samples`, and `stable` fields.");
					return false;
				}
				return true;
			} },
			{ "gateway.runtime.streaming.bandBridge3", [&]() {
				if (!IsFieldNumber(payload, "bandBridge3") || !IsFieldNumber(payload, "samples") || !IsFieldBoolean(payload, "stable")) {
					SetIssue(issue, "schema_invalid_response", "`gateway.runtime.streaming.bandBridge3` requires `bandBridge3`, `samples`, and `stable` fields.");
					return false;
				}
				return true;
            } },
			{ "gateway.runtime.streaming.syncPortal3", [&]() {
				if (!IsFieldNumber(payload, "syncPortal3") || !IsFieldNumber(payload, "samples") || !IsFieldBoolean(payload, "stable")) {
					SetIssue(issue, "schema_invalid_response", "`gateway.runtime.streaming.syncPortal3` requires `syncPortal3`, `samples`, and `stable` fields.");
					return false;
				}
				return true;
			} },
			{ "gateway.runtime.streaming.bandPortal3", [&]() {
				if (!IsFieldNumber(payload, "bandPortal3") || !IsFieldNumber(payload, "samples") || !IsFieldBoolean(payload, "stable")) {
					SetIssue(issue, "schema_invalid_response", "`gateway.runtime.streaming.bandPortal3` requires `bandPortal3`, `samples`, and `stable` fields.");
					return false;
				}
				return true;
            } },
			...
			{ "gateway.runtime.streaming.syncGate3", [&]() {
				if (!IsFieldNumber(payload, "syncGate3") || !IsFieldNumber(payload, "samples") || !IsFieldBoolean(payload, "stable")) {
					SetIssue(issue, "schema_invalid_response", "`gateway.runtime.streaming.syncGate3` requires `syncGate3`, `samples`, and `stable` fields.");
					return false;
				}
				return true;
			} },
			{ "gateway.runtime.streaming.bandGate3", [&]() {
				if (!IsFieldNumber(payload, "bandGate3") || !IsFieldNumber(payload, "samples") || !IsFieldBoolean(payload, "stable")) {
					SetIssue(issue, "schema_invalid_response", "`gateway.runtime.streaming.bandGate3` requires `bandGate3`, `samples`, and `stable` fields.");
					return false;
				}
				return true;
			} },
          ...
          { "gateway.models.failover.reserve", [&]() {
			...
			{ "gateway.models.failover.override.vectorBridge3", [&]() {
				if (!IsFieldBoolean(payload, "active") || !IsFieldNumber(payload, "vectorBridge3") || !IsFieldValueType(payload, "model", '"')) {
					SetIssue(issue, "schema_invalid_response", "`gateway.models.failover.override.vectorBridge3` requires `active`, `vectorBridge3`, and `model` fields.");
					return false;
				}
				return true;
            } },
