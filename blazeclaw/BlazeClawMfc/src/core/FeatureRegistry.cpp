...
FeatureRegistry::FeatureRegistry() {
  m_features = {
      ...
      {L"skills-eligibility-filtering", FeatureState::Planned},
      {L"skills-prompt-snapshots", FeatureState::Planned},
      {L"skills-watch-refresh", FeatureState::Planned},
      {L"skills-sandbox-sync", FeatureState::Planned},
      {L"skills-installer-scanner", FeatureState::Planned},
      {L"skills-operator-surface", FeatureState::Planned},
