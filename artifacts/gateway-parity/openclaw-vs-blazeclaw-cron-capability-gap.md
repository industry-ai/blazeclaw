...
Last refreshed: 2026-05-20 (Phase BW P5 timezone breadth increment refresh)

Authoritative detail: `blazeclaw/docs/cron-parity-gap-and-port-plan.md` (§7.1 work packages WP-A..F)

## Summary

BlazeClaw exposes the full cron/wake RPC surface at the gateway level. P0/P1/P2/P3/P4
execution priorities from §5 are landed; P5 remains active for broader timezone breadth,
with additional zero-offset alias support now present.
...
| P4 | **Complete** (manual terminal-edge payload consistency baseline landed) |
| P5 | **Active** (additional `Etc/*` zero-offset alias support landed, including `Etc/GMT0`) |
| P6+ | **Open** |
...
BlazeClawMfc.Tests.exe "[cron]"   # pass: 1613 assertions / 243 test cases
