...
- `docs/compare/OPENCLAW_GATEWAY_SERVER_TS_CAPABILITY_GAP_AND_PORTING_PLAN.md` (**CLOSED** — `server.ts` façade: **`GatewayUtf8CloseReason`**, `BuildClosePayload`, **`GatewayTestHooks`**; validated **Debug \| x64**)
